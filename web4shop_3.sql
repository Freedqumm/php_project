...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 14 jan. 2024 à 16:53
...
INSERT INTO `cart` (`idProduct`, `idClient`, `quantite`) VALUES
(5, 27, 1);
...
INSERT INTO `customers` (`id`, `forname`, `surname`, `password`, `adress`, `ville`, `postcode`, `phone`, `email`, `registered`) VALUES
(26, 'admin', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '', 'Villeurbanne', '69100', '0613772495', 'admin@gmail.com', 1);
